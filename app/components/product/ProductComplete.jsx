...
const ProductComplete = () => {
  ...
  const [isCategoryOpen, setIsCategoryOpen] = useState(false); // State to control the open/close of categories
    ...
    <>
      <div className="flex flex-wrap md:flex-nowrap 2xl:max-w-[1440px] 2xl:mx-auto 2xl:px-0 md:justify-between justify-center xl:px-[90px] lg:px-[40px] px-5 gap-5">
        <div className="md:w-[26%] xl:w-[350px] w-full mt-14">
          <div className="xl:w-[350px] md:pb-3 bg-white shadow md:block">
            <form className="md:flex mb-3 hidden">
              <input
                type="text"
            ...
            <div className="pb-3 md:pb-0 ">
              <div className="flex items-center content-center justify-between pt-6 mx-4 mb-3">
                <h2 className="text-divi-gray text-2xl font-normal font-nohemi leading-[28.80px]">
                  Categories
                </h2>
                <div
                  className="cursor-pointer" // Make the arrow clickable
                  onClick={toggleCategoryList} // Handle the click event to toggle categories
                >
                  <Image
                    src={ArrowDown}
                    alt="Arrow down"
                    ...
                    }`} // Rotate arrow when categories are hidden
                  />
                </div>
              </div>
